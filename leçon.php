      ...
      <li ><button style="margin-left:1000%;" class="btn btn-success" id="add">Ajouter</button></li>
		...
		<div class="box_general">
			<div class="header_box">
				<h2 class="d-inline-block">Liste des leçons</h2>
				...
				<input class="form-control" type="text" name="nom" id="nom" placeholder="Ajouter le nom de la leçon" required="required"> <br> 
       <label class="form-label" for="time">Durée de la vidéo</label> <input class="form-control" type="time" name="time" id="time" required="required"> <br> 
       <label class="form-label" for="image">Choisir l'image de fond</label> <input class="form-control" accept="accept="image/*" type="file" name="image" id="image"required="required"> <br> 
			...
			<div class="list_general reviews">
                ...
                <li>
						...
						<a href="#modal-reply" data-effect="mfp-zoom-in" class="btn btn-success"><i class="fa fa-fw fa-edit"></i> Modifier une leçon</a>
					  <a href="#modal-reply" style="margin-left:40%;" data-effect="mfp-zoom-in" class="btn btn-danger"><i class="fa fa-fw fa-close"></i> supprimer une leçon</a>
					</p>
